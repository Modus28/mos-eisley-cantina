...
CREATE TABLE `drinkpurchase` (
  ...
  CONSTRAINT `customer_drinkpurchase_fk` FOREIGN KEY (`c_id`) REFERENCES `customer` (`c_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2017-04-01 15:50:21
